...
struct TendensViewx: View {
  @Bindable var tendens: Tendens
  let erNy: Bool
  @Bindable var tendenser: Tendenser
  ...
  var body: some View {
      TendensMålingerView(tendens: $tendensKopi, isEditing: erNy ? true : isEditing)
        .toolbar {
...
//struct TendensViewx_Previews: PreviewProvider {
